				...
				if OnScreen then
					...
					if Character:FindFirstChild("Head") and (ESP.Drawing.Other.Head.Visible or ESP.Drawing.Other.Tracer.Visible) then
						...
						if ESP.Drawing.Other.Tracer.Visible then
							...
							ESP.Drawing.Other.Tracer.From = (ESP.Config[ESP.ConfigName.."/Tracer/Mode"][1] or ESP.Config[ESP.ConfigName.."/Tracer/Mode"]) == "From Mouse" and UserInputService:GetMouseLocation()
								or (ESP.Config[ESP.ConfigName.."/Tracer/Mode"][1] or ESP.Config[ESP.ConfigName.."/Tracer/Mode"]) == "From Bottom" and Vector2.new(Camera.ViewportSize.X / 2,Camera.ViewportSize.Y)
					...
					if ESP.Drawing.Box.Main.Visible or ESP.Drawing.Box.Info.Visible then
						...
						if ESP.Drawing.Box.Info.Visible then
							...
							ESP.Drawing.Box.Info.Font = GetFontFromName(ESP.Config[ESP.ConfigName.."/Text/Font"][1] or ESP.Config[ESP.ConfigName.."/Text/Font"])
